...
import com.ss.editor.ui.controller.model.property.control.particle.influencer.interpolation.element.DestinationWeightInterpolationElement;
...
/**
 * The controller for editing sizes in the {@link DestinationInfluencer}.
 *
 * @author JavaSaBr
 */
public class DestinationInfluencerControl extends AbstractInterpolationInfluencerControl<DestinationInfluencer> {
    ...
    /**
     * Instantiates a new Destination influencer controller.
     *
