package com.ss.editor.ui.controller.property;
...
/**
 * The base implementation of the property controller.
 *
...
public abstract class AbstractPropertyControl<C extends ChangeConsumer, D, T> extends VBox implements UpdatableControl {
    ...
    /**
     * Instantiates a new Abstract property controller.
     *
     ...
     *
     * @return true if this controller has an edit object.
     */
     ...
     *
     * @return true if this controller is single row.
     */
    ...
    /**
     * Create components of this controller.
     *
