 ...
 * @author JavaSaBr
 */
public class UndoRedoOperationControl {
     ...
     */
    public UndoRedoOperationControl(@NotNull final UndoableEditor editor) {
        this.editor = editor;
    ...
    private synchronized void undoImpl() {
        ...
        JFXApplication.semaphore.unlock(this);
//        EditorStateManager.setUpdating();
    ...
    public String toString() {
        return "UndoRedoOperationControl{" +
