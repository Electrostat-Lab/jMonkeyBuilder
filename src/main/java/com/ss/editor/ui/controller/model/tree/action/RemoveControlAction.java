package com.ss.editor.ui.controller.model.tree.action;
...
/**
 * The implementation of the {@link AbstractNodeAction} to remove a controller from a {@link Spatial}.
 *
 * @author JavaSaBr
 */
public class RemoveControlAction extends AbstractNodeAction<ModelChangeConsumer> {
    ...
    /**
     * Instantiates a new Remove controller action.
     *
