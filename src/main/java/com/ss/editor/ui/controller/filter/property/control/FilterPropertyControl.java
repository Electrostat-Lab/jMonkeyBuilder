...
import com.ss.editor.ui.controller.filter.operation.FilterPropertyOperation;
...
/**
 * The base implementation of the property controller for the {@link EditableSceneFilter}.
 *
...
public class FilterPropertyControl<D, T> extends AbstractPropertyControl<SceneChangeConsumer, D, T> {
    ...
    /**
     * Instantiates a new Filter property controller.
     *
