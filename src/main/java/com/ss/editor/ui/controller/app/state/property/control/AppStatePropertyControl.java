...
import com.ss.editor.ui.controller.app.state.operation.AppStatePropertyOperation;
...
/**
 * The base implementation of the property controller for the {@link EditableSceneAppState}.
 *
...
public class AppStatePropertyControl<D, T> extends AbstractPropertyControl<SceneChangeConsumer, D, T> {
    ...
    /**
     * Instantiates a new App state property controller.
     *
