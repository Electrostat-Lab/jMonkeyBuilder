package com.ss.editor.ui.controller.model.tree.dialog;
...
import com.ss.editor.ui.controller.model.tree.action.operation.AddControlOperation;
...
/**
 * The dialog to create a custom controller.
 *
 * @author JavaSaBr
 */
public class CreateCustomControlDialog extends AbstractSimpleEditorDialog {
    ...
    /**
     * The check box to chose an option of creating controller.
     */
    @Nullable
    private CheckBox customCheckBox;

    /**
     * The full class name of creating controller.
     */
    @Nullable
    ...
    /**
     * Instantiates a new Create custom controller dialog.
     *
    ...
    /**
     * @return the check box to chose an option of creating controller.
     */
    @NotNull
    ...
    /**
     * @return the full class name of creating controller.
     */
    @NotNull
    ...
    protected void processOk() {
        ...
        if (customCheckBox.isSelected()) {
            ...
            if (newExample == null) {
                throw new RuntimeException("Can't create a controller of the class " + controlNameField.getText());
            }
