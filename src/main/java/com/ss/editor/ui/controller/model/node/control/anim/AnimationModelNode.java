...
import com.ss.editor.ui.controller.model.tree.action.animation.*;
import com.ss.editor.ui.controller.model.tree.action.operation.animation.RenameAnimationNodeOperation;
...
public class AnimationModelNode extends ModelNode<Animation> {
    ...
    /**
     * The node of an animation controller.
     */
    @Nullable
    ...
    /**
     * Gets controller model node.
     *
     * @return the node of an animation controller.
     */
    @Nullable
    ...
    /**
     * Sets controller model node.
     *
     * @param controlModelNode the node of an animation controller.
     */
