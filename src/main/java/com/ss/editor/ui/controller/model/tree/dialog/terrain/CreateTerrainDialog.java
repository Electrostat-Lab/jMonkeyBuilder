package com.ss.editor.ui.controller.model.tree.dialog.terrain;
...
/**
 * The dialog to create terrain and the terrain generator.
 *
 * @author JavaSaBr
 * @author pavl_g.
 */
public class CreateTerrainDialog extends AbstractSimpleEditorDialog {
    ...
    /**
     * The alpha texture folder controller.
     */
    @Nullable
    private ChooseFolderControl alphaTextureFolderControl;

    /**
     * The base texture controller.
     */
    @Nullable
    private TextureChooser baseTextureComponent;
    ...
    /**
     * The base image controller.
     */
    @Nullable
    private TextureChooser heightMapImageComponent;
    ...
    protected void createContent(@NotNull final VBox root) {
        ...
        baseTextureComponent = new TextureChooser();
        baseTextureComponent.startUiTransactions();
        baseTextureComponent.prefWidthProperty().bind(widthProperty().multiply(DEFAULT_FIELD_W_PERCENT));
        baseTextureComponent.setChangeHandler(this::validate);
        ...
        alphaTextureFolderControl.prefWidthProperty().bind(baseTextureComponent.widthProperty());
        ...
        totalSizeComboBox.prefWidthProperty().bind(baseTextureComponent.widthProperty());
        ...
        patchSizeComboBox.prefWidthProperty().bind(baseTextureComponent.widthProperty());
        ...
        alphaBlendTextureSizeComboBox.prefWidthProperty().bind(baseTextureComponent.widthProperty());
        ...
        heightMapTypeComboBox.prefWidthProperty().bind(baseTextureComponent.widthProperty());
        ...
        baseSettings.add(baseTextureComponent, 1, 5);
        ...
        heightMapImageComponent = new TextureChooser();
        heightMapImageComponent.startUiTransactions();
        heightMapImageComponent.prefWidthProperty().bind(baseTextureComponent.widthProperty());
        heightMapImageComponent.setChangeHandler(this::validate);
        ...
        heightMapSmoothField.prefWidthProperty().bind(baseTextureComponent.widthProperty());
        ...
        heightMapScaleField.prefWidthProperty().bind(baseTextureComponent.widthProperty());
        heightMapScaleField.setValue(1);

        heightMapSettings = new GridPane();
        heightMapSettings.add(heightMapImageControlLabel, 0, 0);
        heightMapSettings.add(heightMapImageComponent, 1, 0);
        ...
        hillIterationsField.prefWidthProperty().bind(baseTextureComponent.widthProperty());
        ...
        hillFlatteningField.prefWidthProperty().bind(baseTextureComponent.widthProperty());
        ...
        hillMinRadiusField.prefWidthProperty().bind(baseTextureComponent.widthProperty());
        ...
        hillMaxRadiusField.prefWidthProperty().bind(baseTextureComponent.widthProperty());
    ...
    /**
     * @return the base texture controller.
     */
    @NotNull
    private TextureChooser getBaseTextureComponent() {
        return notNull(baseTextureComponent);
    }

    /**
     * @return the base image controller.
     */
    @NotNull
    private TextureChooser getHeightMapImageComponent() {
        return notNull(heightMapImageComponent);
    }
    ...
    /**
     * @return the alpha texture folder controller.
     */
    @NotNull
    ...
    private void validate() {
        ...
        final TextureChooser baseTextureControl = getBaseTextureComponent();
        final TextureChooser heightMapImageControl = getHeightMapImageComponent();
